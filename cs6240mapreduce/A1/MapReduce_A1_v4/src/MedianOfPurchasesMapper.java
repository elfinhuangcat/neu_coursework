...
public class MedianOfPurchasesMapper 
    ...
    public void map(LongWritable key, Text value, Context context) 
    	 ...
    	 * Returns: void.
    	 *************************************************/
        // The Fibonacci of N computation - to waste CPU cycles:
    	Fibonacci fib = new Fibonacci();
    	// Compute the fib
    	fib.computeFibonacciIterative(MedianOfPurchases.N);
//    	System.out.println("----Fibonacci of " + MedianOfPurchases.N 
//    			+ ": " + fibResult);
    	
    	// The major mapper operations:
