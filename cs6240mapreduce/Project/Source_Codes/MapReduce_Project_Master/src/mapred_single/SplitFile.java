...
import java.io.RandomAccessFile;
	 ...
	 * 
	 */
//acknowledgement : mapreduce split file api; http://www.javabeat.net/java-split-merge-files/
public class SplitFile {
    ...
    /** Constructs a split with host and cached-blocks information
      ...
      * @param splitSize the size of each part file after splitting
     *  @param outptuName out put path name
      */
    public SplitFile(String fileName, long megaBytesPerSplit, String outputName) throws Exception{
    	this.FILE_NAME =fileName;
    	this.BYTES_PER_SPLIT= megaBytesPerSplit*1048576;
