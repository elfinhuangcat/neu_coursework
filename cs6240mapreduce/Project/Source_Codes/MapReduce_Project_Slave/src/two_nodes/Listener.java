...
public class Listener {
	...
	private String scpDestDir; // the destination dir of scp from slave to master
	private String scpDestFile; // the destination file name of scp from slave to master
	...
	private final String ROOTDIR = MSProtocol.getSlaveRootDir(); 
	protected Listener() {
		this.jarPath = null;
		this.mapObj = null;
		this.splitPath = null;
		...
		this.masterIP = null;
		this.scpDestDir = null;
		this.scpDestFile = null;
	}
	...
	private void parseRequestFromMaster(String request) 
		...
		this.outputKeyCls = Class.forName(masterReq.getKeyClsName());
		this.outputValCls = Class.forName(masterReq.getValClsName());
		...
		this.scpDestDir = masterReq.getDirPath();
		this.scpDestFile = masterReq.getFileName();
	...
	private boolean invokeMapProcess() {
		...
		try {
			...
			MSProtocol.scpFile(this.masterPKeyPath, 
					...
					this.scpDestDir, this.scpDestFile);
